...
int64_t hook(uint32_t reserved)
{
    ...
    for (int64_t i = 0; GUARD(5), i < MAX_ACCOUNTS; i++)
    {
        ...
        {
            break; // No more parameters, stop loop
        }
        ...
        am_drops[account_count] = am_value * 1000000; // Convert XAH to drops
        ...
        else if (param_ac_len == 20)
        {
            ...
            for (int j = 0; j < 20; j++) accounts[account_count][j] = param_ac_raw[j];
        }
        else if (param_ac_len == 40)
        {
            // Hex string, decode to binary
            for (int64_t j = 0; GUARD(20), j < 20; j++)
            {
                uint8_t high = param_ac_raw[j * 2];
                uint8_t low = param_ac_raw[j * 2 + 1];
                ...
                {
                    NOPE("CheckoutPaymentHook: Error: Invalid AC hex string format.");
                }
                ...
                accounts[account_count][j] = (high << 4) | low;
            }
        }
        else
    ...
    TRACEVAR(total_am_drops); // Log total for debugging
...
//     {
//       "HookParameter": {
//         "HookParameterName": "414D31",
//         "HookParameterValue": "000000000000000A"
//       }
//     },
//     {
//       "HookParameter": {
//         "HookParameterName": "414331",
//         "HookParameterValue": "8030AD837CC94A3365BF204B7B5ED1457B3F162A"
//       }
//     },
//     {
//       "HookParameter": {
//         "HookParameterName": "414D32",
//         "HookParameterValue": "0000000000000014"
//       }
//     },
//     {
//       "HookParameter": {
//         "HookParameterName": "414332",
//         "HookParameterValue": "A80B768ADEE306F6C437B8C1976D25AF232BD962"
//       }
//     },
//     {
//       "HookParameter": {
//         "HookParameterName": "414D33",
//         "HookParameterValue": "000000000000001E"
//       }
//     },
//     {
//       "HookParameter": {
//         "HookParameterName": "414333",
//         "HookParameterValue": "A3AD91184B1C571D79C6DCC5C92E2E583DCC599C"
//       }
//     }
//   ],
//   "Flags": "2147483648",
