//**************************************************************
// SafeGuard Hook - HandyHooks Example
// Author: @Handy_4ndy
//
// Description:
...
#define DONE(x) accept(SBUF("Safeguard :: Success :: " x), __LINE__)
#define NOPE(x) rollback(SBUF("Safeguard :: Error :: " x), __LINE__)
