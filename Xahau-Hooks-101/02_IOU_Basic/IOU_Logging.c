/**
 * HandyHooks - IOU Logging Example
 * Demonstrates how to use tracing and logging macros in a Xahau Hook for IOU payments.
 * This example logs account info and payment details, and accepts incoming IOU payments above a minimum amount.
 *
