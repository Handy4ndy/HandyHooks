//**************************************************************
// Blacklist Provider Hook (BPH) - Xahau HandyHook Collection
// Author: @Handy_4ndy
//
// Description:
...
#define DONE(x) accept(SBUF("BPH:: Success :: " x), __LINE__)
#define NOPE(x) rollback(SBUF("BPH:: Error :: " x), __LINE__)
...
{
    TRACESTR("BPH:: Blacklist Provider Hook :: Called.");
